...
public class UbhPaintSpiralShot : UbhBaseShot
{
    ...
    public override void Shot()
    {
        ...
        //スパイラルするようにしたけどうまく回ってない。
        m_paintStartAngle = m_startAngle + (m_shiftAngle * m_nowIndex);
        //m_paintCenterAngle - (m_paintData[0].Count % 2 == 0 ?
